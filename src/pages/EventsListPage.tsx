...
export default function EventsListPage() {
  ...
  const { location, error: locationError, loading: locationLoading, requestLocation, clearLocation, setLocationManually} = UserLocation();
...
const handleAddressSearch = async () => {
  ...
  try {
    ...
    if (result) {
      ...
      clearLocation();
      setaddressError('Could not fond that address - try being more specific.');
    }
  } catch (err) {
  ...
  <div className="min-h-screen bg-black text-white ">
    <div className="max-w-3xl mx-auto px-4">
      ...
      <div className="sticky top-16 z-10 bg-black pt-6 pb-6 flex flex-col gap-4">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-xl border border-neutral-700 bg-neutral-900 px-4 py-3.5 text-sm placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-lime-400"
          />
          <button
      ...
      <div className="py-8">
        ...
        {error && (
          <p role="alert" className="rounded-xl bg-red-950 text-red-400 text-sm px-4 py-3 mb-4">
            {error}
          </p>
        )}
